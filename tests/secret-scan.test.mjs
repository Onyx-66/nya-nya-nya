...
test("Version 49.12.0 is shared by package metadata, the public footer, and admin", async () => {
  ...
  assert.equal(JSON.parse(packageSource).version, "49.12.0");
  assert.match(versionSource, /APP_VERSION = "49\.12\.0"/u);
