...
test("Version 48.1.0 is shared by package metadata, the public footer, and admin", async () => {
  ...
  assert.equal(JSON.parse(packageSource).version, "48.1.0");
  assert.match(versionSource, /APP_VERSION = "48\.1\.0"/u);
