...
export async function GET(request: Request) {
  ...
  try {
    ...
    if (!row.isActive) {
      ...
      if (!actor || !actor.adminPasskeyEnrolled || !actorHasCapability(actor, "announcements.manage")) throw new ApiError(404, "MEDIA_NOT_FOUND", "This ad image is not available.");
    }
