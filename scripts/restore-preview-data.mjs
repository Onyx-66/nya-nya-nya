...
const teams = [
  ["team-onyx", "onyx-archive", "Onyx Archive", "A verified testing team focused on polished reader releases.", "/art/seed/cover-1.jpg", "/art/seed/banner-1.jpg"],
  ["team-starlit", "starlit-forge", "Starlit Forge", "A verified team with weekly discovery releases.", "/art/seed/cover-2.png", "/art/seed/banner-2.jpg"],
  ["team-blue", "blue-lantern", "Blue Lantern", "An active test publishing team for paid and free chapter checks.", "/art/seed/cover-3.jpg", "/art/seed/banner-3.jpg"],
  ["team-kite", "kiteworks", "Kiteworks", "Community translators and release coordinators.", "/art/seed/cover-4.jpg", "/art/seed/banner-4.jpg"],
  ["team-ember", "ember-circle", "Ember Circle", "A testing group for cross-device reader validation.", "/art/seed/cover-5.jpg", "/art/seed/banner-5.jpg"],
];
...
const series = [
  ["ser-solo-leveling", "Solo Leveling", "Na Honjaman Level-Up", "Ten years after gates opened, the weakest hunter discovers a private route to impossible growth.", "MANHWA", "ONGOING", "KR", "ko", 2018, 91, 18240, 43520, 0, ["Action", "Adventure", "Fantasy"], "team-onyx", "/art/seed/cover-1.jpg", "/art/seed/banner-1.jpg", "32d76d19-8a05-4db0-9fc2-e0b0648fe9d0"],
  ["ser-discarded-mercenary", "The Discarded Mercenary Wants to Live Freely", "捨てられ傭兵は自由気ままに生きたい", "After being framed by the commander he trusted, a mercenary chooses a quieter road and finds a new purpose.", "MANGA", "ONGOING", "JP", "ja", 2026, 86, 11380, 24870, 1, ["Adventure", "Drama", "Fantasy"], "team-starlit", "/art/seed/cover-2.png", "/art/seed/banner-2.jpg", "9800fcce-b7af-46d7-aefc-b9364ee75b55"],
  ["ser-frieren", "Frieren: Beyond Journey's End", "葬送のフリーレン", "An elven mage retraces a past adventure and discovers what companionship meant after the journey ends.", "MANGA", "ONGOING", "JP", "ja", 2020, 95, 17660, 39240, 0, ["Adventure", "Drama", "Fantasy"], "team-blue", "/art/seed/cover-3.jpg", "/art/seed/banner-3.jpg", "b0b721ff-c388-4486-aa0f-c2b0bb321512"],
  ["ser-apothecary", "The Apothecary Diaries", "薬屋のひとりごと", "A sharp young apothecary is drawn into palace mysteries where every answer has a hidden cost.", "MANGA", "ONGOING", "JP", "ja", 2017, 89, 14920, 30110, 1, ["Drama", "Mystery", "Romance"], "team-kite", "/art/seed/cover-4.jpg", "/art/seed/banner-4.jpg", "bcfbd2f3-0b8f-4a3c-8f46-5bf0d2e5fa23"],
  ["ser-dandadan", "Dandadan", "ダンダダン", "A pair of students trade ghost stories for alien conspiracies and end up confronting both.", "MANGA", "ONGOING", "JP", "ja", 2021, 87, 13150, 27840, 0, ["Action", "Comedy", "Sci-Fi"], "team-ember", "/art/seed/cover-5.jpg", "/art/seed/banner-5.jpg", "d391c8d4-7a30-4d4b-b6a4-4740ad55cf74"],
  ["ser-blue-lock", "Blue Lock", "ブルーロック", "Strikers enter a ruthless development program where individual ambition is the only way forward.", "MANGA", "ONGOING", "JP", "ja", 2018, 84, 10450, 22200, 0, ["Action", "Drama", "School Life"], "team-onyx", "/art/seed/cover-6.jpg", "/art/seed/banner-6.jpg", "d8f5d4d6-50d8-4f19-9b1c-1e60954fd72d"],
  ["ser-sakamoto-days", "Sakamoto Days", "SAKAMOTO DAYS", "A retired assassin attempts a peaceful life until his former world keeps knocking on the door.", "MANGA", "ONGOING", "JP", "ja", 2020, 83, 9720, 19760, 1, ["Action", "Comedy"], "team-starlit", "/art/seed/cover-7.jpg", "/art/seed/banner-7.jpg", "f3c2e0a4-9c12-4a87-b9d3-3d91e5f6eb3d"],
  ["ser-fragrant-flower", "The Fragrant Flower Blooms With Dignity", "薫る花は凛と咲く", "Two students from rival schools find an unexpectedly gentle friendship across the divide.", "MANGA", "ONGOING", "JP", "ja", 2021, 90, 11800, 25580, 0, ["Drama", "Romance", "School Life"], "team-blue", "/art/seed/cover-8.jpg", "/art/seed/banner-8.jpg", "7c2a6f80-2e86-4caf-9e77-8b53d2eb79d3"],
  ["ser-kaiju-8", "Kaiju No. 8", "怪獣8号", "A cleanup worker gains the power of the monsters he has always fought from the sidelines.", "MANGA", "ONGOING", "JP", "ja", 2020, 82, 8950, 18600, 1, ["Action", "Adventure", "Sci-Fi"], "team-kite", "/art/seed/cover-1.jpg", "/art/seed/banner-1.jpg", "a31c4aa8-7a91-4d2a-9a14-9669ff1a0ee0"],
  ["ser-nagatoro", "Don't Toy With Me, Miss Nagatoro", "イジらないで、長瀞さん", "A quiet upperclassman and an energetic underclassman build an awkward but sincere connection.", "MANGA", "COMPLETED", "JP", "ja", 2017, 80, 7640, 15980, 0, ["Comedy", "Romance", "School Life"], "team-ember", "/art/seed/cover-2.png", "/art/seed/banner-2.jpg", "fc1149d3-1b90-4848-8cbd-b5704d25c91c"],
];
...
for (const [order, seriesIndex] of [0, 1, 2].entries()) {
  ...
  exec(
    `INSERT INTO homepage_sliders (id, series_id, title, category_label, short_description, destination_url, image_key, is_active, sort_order, created_by_user_id)
     VALUES (?, ?, ?, 'Featured', ?, ?, ?, 1, ?, ?)`,
    `slider-${order + 1}`, seriesId, title, `Featured MangaDex metadata brought into the temporary preview for visual testing.`, `/series/${slug(title)}`, `/art/seed/banner-${order + 1}.jpg`, order, owner.id,
  );
